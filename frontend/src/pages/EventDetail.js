          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div>
              ...
              <div className="flex items-center gap-4 text-sm">
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-gray-600">· {event.reviewCount.toLocaleString()} reviews</span>
                </div>
            ...
            {event.required && event.required.length > 0 && (
              <>
                <Separator />
                <div>
                  <h2 className="text-2xl font-bold mb-6">What's required</h2>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="sticky top-24">
              <div className="border rounded-2xl p-6 shadow-xl">
                ...
                {event.freeCancellation && (
                  <p className="text-sm text-gray-600 mb-4 underline">Free cancellation</p>
                )}
                ...
                {/* Host Info */}
                <div>
                  <h3 className="font-semibold text-lg mb-4">Hosted by {event.host.name}</h3>
